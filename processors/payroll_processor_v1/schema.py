...
POSITIONAL_FALLBACK_FIELDS: list[str] = payroll_schema_data()["positional_fallback_fields"]
HEADER_CONFIDENCE_THRESHOLD: float = float(payroll_schema_data()["header_confidence_threshold"])
